...
async def get_temperatures(
    ...
    if city_id is not None:
        return await crud.get_temperature_by_city_id(db=db, city_id=city_id, skip=commons["skip"], limit=commons["limit"])
    return await crud.get_temperatures(db=db, skip=commons["skip"], limit=commons["limit"])
